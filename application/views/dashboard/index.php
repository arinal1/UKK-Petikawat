<?php 
	$pemesanan = $this->db->get_where('pemesan', array('tanggal'=>date('Y-m-d')))->num_rows();
	$admin = $this->db->get_where('user', array('level'=>0))->num_rows();
	$hAdmin = $this->db->get_where('user', array('level'=>1))->num_rows();
?>
		...
		<div class="row">
			...
			<div class="col-xl-2 col-md-4 col-6">
				<div class="wrapper count-title d-flex">
					...
					<div class="name"><strong class="text-uppercase">Pemesanan</strong><span>Hari Ini</span>
						<div class="count-number"><?=$pemesanan?></div>
					</div>
				</div>
			</div>
			<!-- Count item widget-->
			<div class="col-xl-2 col-md-4 col-6">
				<div class="wrapper count-title d-flex">
					...
					<div class="name"><strong class="text-uppercase">Admin</strong><span>Total</span>
			...
			<div class="col-xl-2 col-md-4 col-6">
				<div class="wrapper count-title d-flex">
					...
					<div class="name"><strong class="text-uppercase">Head Admin</strong><span>Total</span>
						<div class="count-number"><?=$hAdmin?></div>
					</div>
				</div>
			</div>
			<!-- Count item widget-->
					...
					<div id="feeds-box" role="tabpanel" class="collapse show">
						<div class="feed-box">
							<ul class="feed-elements list-unstyled">
								...
								<li class="clearfix">
									<div class="feed d-flex justify-content-between">
										<div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?=base_url('assets/img/')?>avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
								...
								<li class="clearfix">
									<div class="feed d-flex justify-content-between">
										<div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?=base_url('assets/img/')?>avatar-6.JPG" alt="person" class="img-fluid rounded-circle"></a>
